...
tableName = "rating"
header = ["media_ID", "average_rating","number_of_votes"]
isStr  = [1, 0, 0]
isMulti = [0, 0, 0] # for multivalued. if in dataset it is seperated by ','
...
f = open("rating.sql", "w+")
title = open("imdb/title.ratings.tsv", "r")

order_fill = [1,2,3] # index 1. -1 -> ignore , from dataset
