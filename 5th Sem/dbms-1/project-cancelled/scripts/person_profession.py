...
tableName = "person_profession"
header = ["profession", "person_ID"]
isStr  = [1, 1]
isMulti = [1, 0] # for multivalued. if in dataset it is seperated by ','
...
f = open("person_profession.sql", "w+")
title = open("imdb/name_new.basics.tsv", "r")

order_fill = [2,-1,-1,-1,1,-1] # index 1. -1 -> ignore , from dataset
