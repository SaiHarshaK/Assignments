...
define dso_local void @_Z11printSubsetPii(i32*, i32) #0 {
...
; <label>:10:                                     ; preds = %6
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 5, i32 %15)
  br label %17
...
define dso_local i32 @_Z10comparatorPKvS0_(i8*, i8*) #2 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline sspstrong uwtable
define dso_local void @_Z10subset_sumPiS_iiiii(i32*, i32*, i32, i32, i32, i32, i32) #0 {
...
; <label>:122:                                    ; preds = %121, %66, %62
  br label %123

; <label>:123:                                    ; preds = %61, %122
  ret void
}

; Function Attrs: noinline sspstrong uwtable
define dso_local void @_Z15generateSubsetsPiii(i32*, i32, i32) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %6 = getelementptr inbounds [8 x i32], [8 x i32]* %2, i32 0, i32 0
