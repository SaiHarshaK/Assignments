...
20:                                               ; preds = %20, %18
  %lsr.iv = phi i64 [ %lsr.iv.next, %20 ], [ %19, %18 ]
  ...
  %23 = icmp eq %"class.std::__cxx11::list"* %lsr.iv.next1, null
  br i1 %23, label %.loopexit, label %20
...
8:                                                ; preds = %13, %7
  %lsr.iv5 = phi i64 [ %lsr.iv.next6, %13 ], [ 0, %7 ]
  %9 = getelementptr inbounds %class.Graph, %class.Graph* %0, i32 0, i32 0
  %10 = load i32, i32* %9, align 8
  %tmp8 = trunc i64 %lsr.iv5 to i32
  %11 = icmp slt i32 %tmp8, %10
...
14:                                               ; preds = %.loopexit.split-lp, %.loopexit
  ...
  %15 = extractvalue { i8*, i32 } %lpad.phi, 0
  %16 = extractvalue { i8*, i32 } %lpad.phi, 1
...
18:                                               ; preds = %30, %17
  %lsr.iv = phi i64 [ %lsr.iv.next, %30 ], [ 0, %17 ]
  %19 = getelementptr inbounds %class.Graph, %class.Graph* %0, i32 0, i32 0
  %20 = load i32, i32* %19, align 8
  %tmp4 = trunc i64 %lsr.iv to i32
  %21 = icmp slt i32 %tmp4, %20
...
27:                                               ; preds = %22
  ...
  invoke void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* %0, i32 %tmp, i8* %6, %"class.std::stack"* dereferenceable(80) %2)
...
32:                                               ; preds = %45, %31
  %33 = invoke zeroext i1 @_ZNKSt5stackIiSt5dequeIiSaIiEEE5emptyEv(%"class.std::stack"* %2)
...
37:                                               ; preds = %34
  %38 = invoke dereferenceable(4) i32* @_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv(%"class.std::stack"* %2)
...
47:                                               ; preds = %14
  %48 = insertvalue { i8*, i32 } undef, i8* %15, 0
  %49 = insertvalue { i8*, i32 } %48, i32 %16, 1
  resume { i8*, i32 } %49
}
